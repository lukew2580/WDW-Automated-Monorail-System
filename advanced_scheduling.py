...
class ScheduleOptimizer:
    ...
    def _setup_stations(self) -> Dict[str, Station]:
        ...
        return {
            "ttr": Station("ttr", "Transportation & Ticket Center", 0, 30, 
                          [MonorailLine.RESORT, MonorailLine.EXPRESS, MonorailLine.EPCOT]),
            "mk": Station("mk", "Magic Kingdom", 1200, 45,
                         [MonorailLine.RESORT, MonorailLine.EXPRESS]),
            "gf": Station("gf", "Grand Floridian Resort", 800, 30,
                         [MonorailLine.RESORT]),
            "pk": Station("pk", "Polynesian Resort", 600, 25,
                         [MonorailLine.RESORT]),
            "epcot": Station("epcot", "Epcot", 2400, 45,
                            [MonorailLine.EXPRESS, MonorailLine.EPCOT]),
            "hs": Station("hs", "Hollywood Studios", 3000, 40,
    ...
    def optimize_routes(self):
        ...
        epcot_route = Route(
            ...
            estimated_time=900,  # 15 minutes round trip
            distance=2400
        )
    ...
    def generate_timetable(self, line: MonorailLine, start_hour: int, end_hour: int, 
        ...
        while current_time < end_time:
            ...
            # Calculate arrival based on route
        ...
        while unvisited:
            ...
            for station_id, station in self.stations.items():
                if station_id in unvisited:
                    ...
                    dist = abs(station.position - self.stations[current].position) / 5280  # Convert to miles
    ...
    def estimate_wait_time(self, station_id: str, line: MonorailLine) -> int:
        ...
        route = self.routes[line.value][0]
        interval_minutes = 10
        return interval_minutes // 2  # Average wait is half the interval
...
async def demo_scheduling():
    ...
    for line in MonorailLine:
        ...
        for entry in timetable[:3]:  # Show first 3
